...
<div class="form-style-5">
        <legend><span class="number">1</span> View Addresses Of Clients</legend> 
  ...
  <tr>
    ...
    <th>Zipcode</th>
             ...
             <c:forEach items="${client.addresses}" var="address">  
                <tr>
                    <td><a href="${pageContext.request.contextPath}/AddressController?action=updateAddress&addressId=${address.addressId}&userType=${address.userType}&id=${client.id}"/>Update</a></td>
