...
window.location.href="${pageContext.request.contextPath}/EmployeeController?action=showEmployee";
}
 </script>
    </head>
    <body>
...
<div class="form-style-5">
        <legend><span class="number">1</span> Delete Employee Addresses</legend> 
   ...
   <c:when test="${empty employee.addresses}">
    ...
    <c:otherwise>
             <c:forEach items="${employee.addresses}" var="address">  
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" name="action" value="deleteEmployeeAddresses">Delete Addresses</button>
